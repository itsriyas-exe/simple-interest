...
function App() {
  ...
  return (
    <>
     <main className='flex justify-center items-center w-full h-screen bg-dark'>
        <section className='w-[350px] h-[600px] flex justify-top p-[25px] items-center flex-col rounded'>
            ...
            <div className='pos w-[260px] h-[140px] mb-[30px] flex justify-center items-center flex-col text-white rounded'>
            ...
            {!isPrinciple  && <span className='-ml[10px text-red-600'>*invalid input</span>}
            ...
            {!isRate  && <span className='-ml[10px text-red-600'>*invalid input</span>}
            <p className='-ml-[215px] -mb-[7px]'>Year</p>
            ...
            {!isYear  && <span className='-ml[10px text-red-600'>*invalid input</span>}
            <div className='w-[260px] h-[100px] flex justify-between items-center'>
              ...
              <button className='bg-red-600 text-white font-semibold px-[16px] py-[8px] rounded' onClick={handleReset} >Reset</button>
            </div>
